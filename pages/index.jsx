    ...
    return (
        <div style={{ 
            ...
            <a href="https://wa.me/56932465215" target="_blank" rel="noopener noreferrer" className="wsp-float">
                ...
                <svg width="30" height="30" viewBox="0 0 24 24" fill="currentColor"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.246 2.248 3.484 5.232 3.484 8.412 0 6.556-5.338 11.892-11.893 11.892-1.997-.001-3.951-.5-5.688-1.448l-6.309 1.656zm6.224-3.82c1.516.903 3.135 1.389 4.793 1.391 5.421 0 9.833-4.412 9.833-9.832 0-2.628-1.023-5.097-2.88-6.956-1.857-1.859-4.325-2.883-6.953-2.883-5.422 0-9.835 4.412-9.835 9.832-.001 1.742.454 3.441 1.316 4.931l-1.011 3.693 3.73-1.005zm11.547-7.912c-.301-.151-1.781-.878-2.057-.978-.275-.1-.476-.151-.675.151-.199.302-.77.978-.944 1.179-.175.199-.349.226-.651.076-.301-.151-1.274-.47-2.426-1.5-.896-.799-1.5-1.787-1.675-2.089-.175-.301-.019-.465.131-.615.136-.135.301-.352.451-.527.151-.176.201-.302.302-.503.1-.199.05-.376-.025-.526-.075-.151-.675-1.631-.925-2.23