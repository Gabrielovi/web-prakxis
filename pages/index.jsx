    ...
    return (
        <div style={{ backgroundColor: colors.bgLight, color: colors.textDark, minHeight: '100vh', fontFamily: 'sans-serif', overflowX: 'hidden' }}>
            ...
            <main>
                ...
                {/* PRENSA - AJUSTE DE ANCHO PARA CELULAR */}
                ...
                <section id="audiovisual" style={{ padding: '40px 20px', maxWidth: '1150px', margin: '0 auto' }}>
            ...
            <style jsx>{`
                ...
                .nav-links a { color: ${colors.textLight}; text-decoration: none; font-size: 10px; font-weight: 500; text-transform: uppercase; }
                ...
                /* AJUSTE CLAVE: Ancho de tarjeta para móvil */
                .scroll-horizontal { display: flex; overflow-x: auto; gap: 15px; padding-bottom: 15px; -webkit-overflow-scrolling: touch; width: 100%; padding-left: 5px; }
                ...
                .contact-form-container { max-width: 500px; margin: 0 auto; padding: 25px; background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.2); }
